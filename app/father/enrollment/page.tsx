...
import { mockStudents, mockEnrollments } from "@/data/mock";
...
export default function EnrollmentPage() {
  ...
  const enrollment = mockEnrollments.find((e) => e.studentId === activeStudentId);
    ...
    <div className="space-y-8">
      ...
      <div className="flex gap-3 flex-wrap">
        {mockStudents.map((s) => {
          ...
          const enr = mockEnrollments.find((e) => e.studentId === s.id);
          return (
            <button
              key={s.id}
            ...
            >
              ...
              <div className="text-left">
                ...
                <p className="text-xs text-muted-foreground">
                  {enr ? `${enr.grade} "${enr.section}"` : `${s.grade} "${s.section}"`}
                </p>
              </div>
            </button>
          );
